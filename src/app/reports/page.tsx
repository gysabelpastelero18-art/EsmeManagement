...
export default function Reports() {
  ...
  const handleReportClick = (reportType: string) => {
    if (reportType === 'Daily Production') {
      ...
      alert(`${reportType} report coming soon!`);
    }
  };
        ...
        <html>
          ...
          <body>
            <div class="header">
              ...
              <h2>${selectedBranch} • ${selectedDepartment}</h2>
        ...
        >
          ...
          >
            {[
              ...
              },
              {
                ...
                color: '#FF9800',
                items: ['Daily Production', 'Department Performance', 'Waste Analysis', 'Stock Levels']
              },
              {
                icon: '💰',
                        ...
                        <tr style={{ 
                          ...
                          {getWeekDates(selectedWeek).map((day) => (
                            <th key={day.name} style={{ 
                              ...
                              <div style={{ fontSize: '13px', fontWeight: '800', marginBottom: '2px' }}>{day.name}</div>
                      ...
                      <tbody>
                        {productionData.length > 0 ? productionData.map((row, index) => (
                          ...
                          >
                            ...
                            <td style={{ textAlign: 'center', padding: '12px 8px', color: '#FF6B35', fontWeight: '600', border: '1px solid #d3d3d3', fontSize: '14px' }}>{row.Monday || 0}</td>
                            <td style={{ textAlign: 'center', padding: '12px 8px', color: '#FF6B35', fontWeight: '600', border: '1px solid #d3d3d3', fontSize: '14px' }}>{row.Tuesday || 0}</td>
                            <td style={{ textAlign: 'center', padding: '12px 8px', color: '#FF6B35', fontWeight: '600', border: '1px solid #d3d3d3', fontSize: '14px' }}>{row.Wednesday || 0}</td>
                            <td style={{ textAlign: 'center', padding: '12px 8px', color: '#FF6B35', fontWeight: '600', border: '1px solid #d3d3d3', fontSize: '14px' }}>{row.Thursday || 0}</td>
                            <td style={{ textAlign: 'center', padding: '12px 8px', color: '#FF6B35', fontWeight: '600', border: '1px solid #d3d3d3', fontSize: '14px' }}>{row.Friday || 0}</td>
                            <td style={{ textAlign: 'center', padding: '12px 8px', color: '#FF6B35', fontWeight: '600', border: '1px solid #d3d3d3', fontSize: '14px' }}>{row.Saturday || 0}</td>
                            <td style={{ textAlign: 'center', padding: '12px 8px', color: '#FF6B35', fontWeight: '600', border: '1px solid #d3d3d3', fontSize: '14px' }}>{row.Sunday || 0}</td>
                            <td style={{ 
                              textAlign: 'center', 
                              padding: '12px 8px', 
                              color: '#FF9800', 
                          ...
                          <tr style={{ 
                            ...
                            {['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'].map((day) => (
                              <td key={day} style={{ 
                                ...
                                {productionData.reduce((sum, item) => sum + item[day], 0)}
                              </td>
                            ))}
                            <td style={{ 
                              textAlign: 'center', 
                              ...
                              {productionData.reduce((sum, item) => sum + item.total, 0)}
                            </td>
                          </tr>
                        </tfoot>
                      )}
          ...
          {selectedReport === null && (
            ...
            >
              ...
              <h2 style={{ color: '#006400', fontSize: '24px', fontWeight: '700', marginBottom: '8px' }}>
                Reports Coming Soon!
              </h2>
              <p style={{ color: '#4A6741', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>
                We're working on comprehensive reporting features to help you analyze your business data. 
                These reports will provide detailed insights into sales performance, production efficiency, 
                financial metrics, and operational analytics to support your decision-making process.
              </p>
            </div>
          )}
        </main>
