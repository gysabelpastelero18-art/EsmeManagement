  ...
  const getBranchComparisonData = () => {
    return {
      mayon: {
        ...
        growth: '+14.2%',
        categories: [
          { category: '🥖 Bakery', units: 145, revenue: '₱24,680', growth: '+18%' },
          { category: '🥤 Beverages', units: 189, revenue: '₱28,950', growth: '+12%' },
          { category: '🥘 Commissary', units: 167, revenue: '₱35,420', growth: '+8%' },
          { category: '🍰 Desserts', units: 156, revenue: '₱18,720', growth: '+15%' },
          { category: '🍳 Kitchen Items', units: 245, revenue: '₱45,680', growth: '+10%' },
          { category: '🍽️ Others: Corkage', units: 42, revenue: '₱3,850', growth: '+25%' },
          { category: '🚚 Others: Delivery Fee', units: 68, revenue: '₱5,240', growth: '+20%' },
          { category: '⭐ Others: Service Charge', units: 52, revenue: '₱4,680', growth: '+18%' }
        ]
      },
      balete: {
        ...
        growth: '+10.8%',
        categories: [
          { category: '🥖 Bakery', units: 134, revenue: '₱21,680', growth: '+16%' },
          { category: '🥤 Beverages', units: 165, revenue: '₱24,950', growth: '+9%' },
          { category: '🥘 Commissary', units: 145, revenue: '₱28,420', growth: '+6%' },
          { category: '🍰 Desserts', units: 132, revenue: '₱15,720', growth: '+12%' },
          { category: '🍳 Kitchen Items', units: 198, revenue: '₱38,680', growth: '+8%' },
          { category: '🍽️ Others: Corkage', units: 35, revenue: '₱2,850', growth: '+22%' },
          { category: '🚚 Others: Delivery Fee', units: 48, revenue: '₱3,940', growth: '+15%' },
          { category: '⭐ Others: Service Charge', units: 41, revenue: '₱3,480', growth: '+14%' }
        ]
      }
    };
  };
